...
const rejectionData = [
  ...
  { date: "13-09-2024", srNo: 6, machine: "18-200T", defect: "Heavy Dent", rejected: 2 },
  ...
  { date: "13-09-2024", srNo: 9, machine: "22-250T", defect: "Dent on RM", rejected: 2 },
];
...
const Rejection = () => {
  ...
  const filteredData = rejectionData.filter((item) => {
    ...
    const matchesDate = item.date === selectedDate.split("-").reverse().join("-");
    ...
    <div className="bg-white shadow-md p-4">
      <div className="flex justify-between items-center bg-blue-600 text-white p-3 rounded-t-md">
        ...
        <div className="flex items-center gap-3">
          ...
          />
          <select
            className="border text-black border-gray-300 p-1 text-sm w-40"
